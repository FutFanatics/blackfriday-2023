...
import icontel from '../assets/img/icon/whats.svg';
import iconcertificado1 from '../assets/img/icon/image-1.svg';
import iconcertificado2 from '../assets/img/icon/image-2.svg';
import iconcertificado3 from '../assets/img/icon/image-3.svg';
import iconcertificado4 from '../assets/img/icon/image-4.svg';

import pagament1 from '../assets/img/icon/pagament/elo.svg';
import pagament2 from '../assets/img/icon/pagament/master.svg';
import pagament3 from '../assets/img/icon/pagament/hipercard.svg';
import pagament4 from '../assets/img/icon/pagament/diners_club.svg';
import pagament5 from '../assets/img/icon/pagament/boleto.svg';
import pagament6 from '../assets/img/icon/pagament/american.svg';
import pagament7 from '../assets/img/icon/pagament/visa.svg';

import playstore from   '../assets/img/icon/playstore.svg';
import applestore from '../assets/img/icon/applestore.svg';

import signature from '../assets/img/icon/futfanatics.svg';

import facebook from '../assets/img/icon/share/facebook.svg';
import twitter from '../assets/img/icon/share/twitter.svg';
import instagram from '../assets/img/icon/share/instagram.svg';
import tiktok from '../assets/img/icon/share/tiktok.svg';
import youtube from '../assets/img/icon/share/youtube.svg';

import iconSac from '../assets/img/icon/sac.svg'
